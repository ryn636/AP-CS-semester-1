...
class starter {
	...
	public static int checkHorizontal(String[][] board){
		...
		for (int c = 0; c <board[0].length-3; c++){
			if (board[r][c].equals(board[r][c+1]) && board[r][c].equals(board[r][c+2]) && board[r][c].equals(board[r][c+3])){
				if (board[r][c].equals("A")){
					return 1;
				} else if (board[r][c].equals("B")){
					return 2;
	...
	public static int checkDiagonal(String[][] board){
		for (int r = 0; r < board.length-3; r++){
			for(int c = board[0].length-1; c > 2; c--){
				if (board[r][c].equals(board[r+1][c-1]) && board[r][c].equals(board[r+2][c-2]) && board[r][c].equals(board[r+2][c-2])){
					if (board[r][c].equals("A")){
						return 1;
					} else if (board[r][c].equals("B")){
						return 2;
